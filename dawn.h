...
#define CONFIG2_ALL_SAY_IC   (Q)  // If set, all says by character are IC
#define CONFIG2_NO_SAY_OOC      (R)  // If set the character will not receive OOC says

#define SAYFLAG_IC               (D)  // Is this an IC say? 
// where definitions 
